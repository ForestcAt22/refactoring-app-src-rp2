...
public class DBController {
		...
		try {
			...
			while (resultSet.next()) {
				...
				if (deptIdValue == Constants.DEPARTMENT_ID_SALES) {
					System.out.print(Constants.DEPARTMENT_STR_SALES);
				} else if (deptIdValue == Constants.DEPARTMENT_ID_ACCOUNTING) {
					System.out.print(Constants.DEPARTMENT_STR_ACCOUNTING);
				} else if (deptIdValue == Constants.DEPARTMENT_ID_GENERAL) {
					System.out.print(Constants.DEPARTMENT_STR_GENERAL);
	...
	public static void insert(String empName, String gender, String birthday, String deptId)
		...
		try {
			...
			// 入力値をバインド
			preparedStatement.setString(Constants.INSERT_PARAM_EMPLOYEE_NAME, empName);
			preparedStatement.setString(Constants.INSERT_PARAM_GENDER, gender);
			preparedStatement.setString(Constants.INSERT_PARAM_BIRTHDAY, birthday);
			preparedStatement.setString(Constants.INSERT_PARAM_DEPARTMENT_ID, deptId);
